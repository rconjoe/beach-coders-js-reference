...
myPenguin.sayHello = "CHIRP CHIRP! Is this what penguins sound like?"
function penguin () {
    console.log(this.name)
}
myPenguin.penguin = penguin;

console.log(myPenguin.penguin()) //not sure whats coming up as undefined
